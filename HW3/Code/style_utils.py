...
def style_transfer(name, content_image, style_image, image_size, style_size, content_layer, content_weight,
    ...
    for t in range(200):
        ...
        content_loss_term = content_loss(content_weight, content_current, content_target)
        style_loss_term = style_loss(feats, style_layers, style_targets, style_weights)
        tv_reg = tv_loss(img, tv_weight)
        
        loss = content_loss_term + style_loss_term + tv_reg
